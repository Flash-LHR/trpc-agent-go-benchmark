...
git clone https://github.com/trpc-group/trpc-agent-go-benchmark.git
cd trpc-agent-go-benchmark

# Option 2: Already cloned but LFS files not pulled
git lfs pull

# Option 3: Pull only LFS files in the data directory
git lfs pull --include="gaia/data/**"
```
...
head -c 100 gaia/data/2023/validation/cca530fc-4052-43b2-b130-b30968d8aa44.png
...
- [trpc-agent-go-benchmark GitHub](https://github.com/trpc-group/trpc-agent-go-benchmark)
